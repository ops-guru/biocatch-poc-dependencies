...
start_pod = KubernetesPodOperator(
    ...
    namespace="operators",
    image="alpine/helm",
    cmds=['/bin/sh', '-c', 'helm repo add poc https://raw.githubusercontent.com/ops-guru/biocatch-poc-dependencies/main/charts/ && helm upgrade -i airflow-job-1 poc/spark-application'],
