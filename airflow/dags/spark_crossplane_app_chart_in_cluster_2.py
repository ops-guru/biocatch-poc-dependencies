...
start_spark_pod = KubernetesPodOperator(
    ...
    service_account_name=crossplane_app_name,
    do_xcom_push=False,
    is_delete_operator_pod=True,
    get_logs=True,
    log_events_on_failure=True,
